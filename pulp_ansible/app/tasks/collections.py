...
def import_collection(
    ...
    filename = None
    if expected_namespace and expected_name and expected_version:
    ...
    with _artifact_guard(artifact):
        ...
        try:
            ...
            # NOTE(cutwater): Because this one is expected, probably should wrap into some
            # kind of pulp worker exception to produce better task result.
